...
const DOKGUN_STICKER_EN: Art = {
    ...
    name: {
        [Locale.tc]: '독군 Dokgun - 貼圖 (英文)',
        [Locale.sc]: '독군 Dokgun - 贴图 (英文)',
        [Locale.en]: '독군 Dokgun - Sticker (English)',
        [Locale.jp]: '독군 Dokgun - スタンプ (英語)',
        [Locale.kr]: '독군 Dokgun - 스티커 (영어)',
    },
    remark: {
    ...
    paths: ArtFile.DOKGUN_STICKER_EN,
}
