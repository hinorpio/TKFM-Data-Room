...
export const General_10025: Unit = {
    ...
    tagList: [],
    otherVersion: [ UnitCode.iblis, UnitCode.b_iblis, UnitCode.s_iblis, UnitCode.v_iblis, UnitCode.x_iblis, UnitCode.bg_iblis, UnitCode.ss_iblis, UnitCode.fifth_iblis ],
    initHP: 4400,
    initATK: 726.4,
    puzzle: [],
    outfits: [],
    voiceSet: UnitVoice[UnitCode.i_iblis],
    voiceException: [
        {
            version: 1,
            exception: [],
