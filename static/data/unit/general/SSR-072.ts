...
export const General_10108: Unit = {
    ...
    tagList: [],
    otherVersion: [ UnitCode.baal, UnitCode.f_baal, UnitCode.b_baal, UnitCode.s_baal, UnitCode.x_baal, UnitCode.sky_baal, UnitCode.fifth_baal ],
    initHP: 4409.6,
    initATK: 800,
    puzzle: [],
    outfits: [],
    voiceSet: UnitVoice[UnitCode.v_baal],
    voiceException: [
        {
            version: 1,
            exception: [],
