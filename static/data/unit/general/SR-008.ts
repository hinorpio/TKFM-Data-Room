...
export const General_10016: Unit = {
    ...
    otherVersion: [ UnitCode.h_britney, UnitCode.m_britney, UnitCode.x_britney, UnitCode.g_britney, UnitCode.s_britney ],
    initHP: 3158.4,
    initATK: 736.4,
    puzzle: [],
    outfits: [],
    voiceSet: UnitVoice[UnitCode.britney],
    voiceException: [
        {
            version: 1,
            exception: [],
