...
export const General_10072: Unit = {
    ...
    tagList: [],
    otherVersion: [ UnitCode.baal, UnitCode.f_baal, UnitCode.v_baal, UnitCode.s_baal, UnitCode.x_baal, UnitCode.sky_baal, UnitCode.fifth_baal ],
    initHP: 3462.4,
    initATK: 1017.6,
    puzzle: [],
    outfits: [],
    voiceSet: UnitVoice[UnitCode.b_baal],
    voiceException: [
        {
            version: 1,
            exception: [],
