...
export const General_10042: Unit = {
    ...
    tagList: [],
    otherVersion: [ UnitCode.iblis, UnitCode.i_iblis, UnitCode.b_iblis, UnitCode.v_iblis, UnitCode.x_iblis, UnitCode.bg_iblis, UnitCode.ss_iblis, UnitCode.fifth_iblis ],
    initHP: 3456,
    initATK: 1019.2,
