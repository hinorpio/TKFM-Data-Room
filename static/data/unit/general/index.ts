...
import { General_10179 } from "./SSR-150";
import { General_10180 } from "./SSR-151";
import { General_10181 } from "./SSR-152";
import { General_10182 } from "./SSR-153";
import { General_10183 } from "./SSR-154";
import { General_10184 } from "./SSR-155";
...
import { General_10192 } from "./SSR-163";
import { General_10193 } from "./SSR-164";
import { General_10194 } from "./SSR-165";
import { General_10195 } from "./SSR-166";
import { General_10196 } from "./SSR-167";
import { General_10197 } from "./SSR-168";
import { General_10198 } from "./SSR-169";
import { General_10199 } from "./SSR-170";
import { General_10200 } from "./SSR-171";
import { General_10201 } from "./SSR-172";
import { General_10202 } from "./SSR-173";
import { General_10203 } from "./SSR-174";
import { General_10204 } from "./SSR-175";
import { General_10205 } from "./SSR-176";
import { General_10206 } from "./SSR-177";
import { General_10207 } from "./SSR-178";
import { General_10208 } from "./SSR-179";
import { General_10209 } from "./SSR-180";
import { General_10210 } from "./SSR-181";
...
const SSR: { [key in UnitCode]?: Unit } = {
    ...
    [UnitCode.n_lulu]: General_10179,
    [UnitCode.yuri]: General_10180,
    [UnitCode.l_ayane]: General_10181,
    [UnitCode.ria]: General_10182,
    [UnitCode.g_britney]: General_10183,
    [UnitCode.h_momDaphne]: General_10184,
    ...
    [UnitCode.b_shizuka]: General_10192,
    [UnitCode.m_usagihime]: General_10193,
    [UnitCode.b_aiko]: General_10194,
    [UnitCode.b_ayane]: General_10195,
    [UnitCode.b_lana]: General_10196,
    [UnitCode.cos_yanko]: General_10197,
    [UnitCode.cos_momo]: General_10198,
    [UnitCode.egypt_fiora]: General_10199,
    [UnitCode.egypt_milae]: General_10200,
    [UnitCode.m_momDaphne]: General_10201,
    [UnitCode.nali]: General_10202,
    [UnitCode.otohime]: General_10203,
    [UnitCode.s_britney]: General_10204,
    ...
    [UnitCode.w_noma]: General_10209,
    [UnitCode.ciel]: General_10210,
}
