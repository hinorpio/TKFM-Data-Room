...
export const General_10019: Unit = {
    ...
    background: {
        ...
        [Locale.sc]: `被法斯帝国勇者召唤仪式召唤过来的「现代勇者」。生活在高楼大厦林立，车水马龙的现代勇者，本身只是普通的女高中生，不过在被召唤后获得了加护技能。在加护技能的效果下，获得了超人一样的身体能力以及学习力，只要学习就能娴熟的使用各种魔法和武器。因为不喜法斯帝国的对待他国的高压姿态，原本不想成为勇者，不过最后还是无法坐视无辜的人民被卷入战争而参战。由于来自和平的世界，最开始并不擅长战斗，但是在召唤勇者中是最具成长潜力的人。\n\n『本来不想用这招的…偶尔也会想这么说。』`,
    ...
    otherVersion: [ UnitCode.s_ayane, UnitCode.h_ayane, UnitCode.r_ayane ],
    puzzle: [],
    skillSet: []
}