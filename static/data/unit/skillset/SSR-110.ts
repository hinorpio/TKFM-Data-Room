...
export const SkillSet_10140: SkillSet[] =  [
    {
        ...
        skill: {
            ...
            [Locale.kr]: {
                [SkillType.SKILL_S]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 330/376/422/468/514%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 10/12.5/15/17.5/20% 감소(2턴) [CD: 4]`
                },
                [SkillType.SKILL_1]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 330%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 10% 감소(2턴) [CD: 4]`
                },
                [SkillType.SKILL_2]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 376%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 12.5% 감소(2턴) [CD: 4]`
                },
                [SkillType.SKILL_3]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 422%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 15% 감소(2턴) [CD: 4]`
                },
                [SkillType.SKILL_4]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 468%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 17.5% 감소(2턴) [CD: 4]`
                },
                [SkillType.SKILL_5]: {
                    name: `별의 귀환`,
                    description: `자신의 공격 데미지의 514%만큼 타깃에게 데미지, 아군 1번 자리, 2번 자리, 3번 자리 캐릭터의 받는 데미지 20% 감소(2턴) [CD: 4]`
                },
                [SkillType.ATTACK]: {
                    name: `추잡한 소리`,
                ...
                [SkillType.LEADER]: {
                    name: `왜곡 의식`,
                    description: `자신의 최대 HP 50% 증가\n아군 전체의 공격 데미지 100% 증가\n자신은 궁극기 발동 시 「자신의 공격 데미지의 400%만큼 타깃에게 데미지」발동\n자신은 공격 시 「자신의 최대 HP 1%만큼 자신 이외의 아군 전체에게 데미지」발동\n자신이 데미지를 가할 시, 가한 데미지의 25%만큼 자신의 HP 회복\n아군 2번 자리, 3번 자리는 《살아있는 제물》획득\n\n《살아있는 제물》\n가하는 데미지 300% 감소\n공격 시 「자신의 기본 공격 데미지의 125%만큼 아군 1번 자리 캐릭터의 공격 데미지 증가(1턴)」발동\n궁극기 발동 시 「타깃이 받는 암속성 데미지 14% 증가(2턴)」발동\n첫 번째 턴에서 「자신은《의식 박리》획득」발동\n\n《의식 박리》\n자신이 딜러일 시：\n행동 시 「아군 1번 자리 캐릭터는 궁극기 발동 시 『자신의 최대 HP의 100%만큼 타깃에게 데미지를 가하고 다시 자신의 공격 데미지의 150%만큼 타깃에게 데미지』발동(50턴), 가하는 데미지 25%증가(50턴)」발동(1턴)\n자신이 디스럽터일 시：\n행동 시 「아군 1번 자리 캐릭터는 공격 시 『타깃이 받는 치유량 50% 감소(2턴)』발동(50턴), 궁극기 발동 시 『타깃이 받는 데미지 45% 증가(9턴)』발동(50턴), 가하는 데미지 25% 증가(50턴)」발동(1턴)\n자신이 탱커, 힐러, 서포터일 시：\n자신의 공격 데미지 600% 감소(50턴)`
                },
                [SkillType.PASSIVE_1]: {
                    name: `심연의 관저`,
