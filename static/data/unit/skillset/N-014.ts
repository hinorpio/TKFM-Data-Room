...
export const SkillSet_10914: SkillSet[] =  [
    {
        version: 1,
        lastDate: "",
        remark: {
        ...
        skill: {
            [Locale.tc]: {
                [SkillType.SKILL_S]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力265/298/331/364/399%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.SKILL_1]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力265%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.SKILL_2]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力298%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.SKILL_3]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力331%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.SKILL_4]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力364%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.SKILL_5]: {
                    name: `麻痺毒牙`,
                    description: `以攻擊力399%對目標造成傷害，再以50%機率使目標麻痺1回合，CD: 3`
                },
                [SkillType.ATTACK]: {
                    name: `撕咬`,
                ...
                [SkillType.LEADER]: {
                    name: `火之鼓舞`,
                    description: `使我方火屬性角色攻擊力增加10%`
                },
                [SkillType.PASSIVE_1]: {
                    name: `致傷毒液`,
                    description: `攻擊時，觸發"使目標被治療時被回復量減少25%(2回合)"效果`
                },
                [SkillType.PASSIVE_2]: {
                    name: `迅蛇猛行`,
            ...
            [Locale.sc]: {
                [SkillType.SKILL_S]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力265/298/331/364/399%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.SKILL_1]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力265%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.SKILL_2]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力298%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.SKILL_3]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力331%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.SKILL_4]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力364%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.SKILL_5]: {
                    name: `麻痹毒牙`,
                    description: `以攻击力399%对目标造成伤害，再以50%机率使目标麻痹1回合，CD: 3`
                },
                [SkillType.ATTACK]: {
                    name: `撕咬`,
                ...
                [SkillType.LEADER]: {
                    name: `火之鼓舞`,
                    description: `使我方火属性角色攻击力增加10%`
                },
                [SkillType.PASSIVE_1]: {
                    name: `致伤毒液`,
                    description: `攻击时，触发"使目标被治疗时被回复量减少25%(2回合)"效果`
                },
                [SkillType.PASSIVE_2]: {
                    name: `迅蛇猛行`,
            ...
            [Locale.jp]: {
                [SkillType.SKILL_S]: {
                    name: `麻痺の毒牙`,
                    description: `265/298/331/364/399%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.SKILL_1]: {
                    name: `麻痺の毒牙`,
                    description: `265%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.SKILL_2]: {
                    name: `麻痺の毒牙`,
                    description: `298%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.SKILL_3]: {
                    name: `麻痺の毒牙`,
                    description: `331%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.SKILL_4]: {
                    name: `麻痺の毒牙`,
                    description: `364%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.SKILL_5]: {
                    name: `麻痺の毒牙`,
                    description: `399%の攻撃力でターゲットにダメージを与え、さらに50%の確率で麻痺(1ターン)を与える[CD:3]`
                },
                [SkillType.ATTACK]: {
                    name: `噛みちぎる`,
