...
export const SkillSet_10133: SkillSet[] =  [
    {
        version: 1,
        lastDate: "",
        remark: {
        ...
        skill: {
            [Locale.tc]: {
                ...
                [SkillType.ATTACK]: {
                    name: `不許看著別人哦～♡`,
                    description: `以自身攻擊力25%給予我方全體護盾(1回合)、以自身最大HP30%給予我方全體護盾(1回合)`
                },
                [SkillType.LEADER]: {
                    name: `握手會時間到～`,
            ...
            [Locale.sc]: {
                ...
                [SkillType.ATTACK]: {
                    name: `不许看着别人哦～♡`,
                    description: `以自身攻击力25%给予我方全体护盾(1回合)丶以自身最大HP30%给予我方全体护盾(1回合)`
                },
                [SkillType.LEADER]: {
                    name: `握手会时间到～`,
                    description: `我方全体攻击力增加50%\n我方全体造成触发技效果增加100%\n我方全体造成伤害增加20%\n自身获得，我方队伍辅助者角色有2人以上时，发动「受到护盾效果减少600%」\n\n使自身以外我方全体获得《钱没有消失》\n使自身获得《只是变成奈奈美的形状》 \n\n《钱没有消失》\n攻击时，触发「以自身攻击力30给予我方站位1角色护盾(1回合)」\n\n《只是变成奈奈美的形状》\n普攻时，触发「以自身当前护盾值55对目标造成伤害」\n必杀时，触发「以自身当前护盾值60对目标造成伤害」\n攻击时，触发「以自身当前护盾值100对自身护盾造成真实伤害」`
                },
                [SkillType.PASSIVE_1]: {
                    name: `登台准备`,
                    description: `使自身造成护盾效果增加15%`
                },
                [SkillType.PASSIVE_2]: {
                    name: `「清纯」偶像`,
