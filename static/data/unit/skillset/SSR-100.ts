...
export const SkillSet_10130: SkillSet[] =  [
    {
        ...
        skill: {
            ...
            [Locale.kr]: {
                [SkillType.SKILL_S]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `타깃이 받는 데미지 0/0/20/20/25% 증가(3턴), 자신의 공격 데미지의 211/234/256/278/300%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 156/156/178/178/200%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.SKILL_1]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `자신의 공격 데미지의 211%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 156%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.SKILL_2]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `자신의 공격 데미지의 234%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 156%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.SKILL_3]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `타깃이 받는 데미지 20% 증가(3턴), 자신의 공격 데미지의 256%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 178%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.SKILL_4]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `타깃이 받는 데미지 20% 증가(3턴), 자신의 공격 데미지의 278%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 178%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.SKILL_5]: {
                    name: `이 일격으로 머리를 뚫어버린다!`,
                    description: `타깃이 받는 데미지 25% 증가(3턴), 자신의 공격 데미지의 300%만큼 타깃에게 데미지, 자신은 「피격 시 『자신의 공격 데미지의 200%만큼 타깃에게 반격(1회 발동 후 해제)』발동(3턴)」획득, 자신은 도발 효과 획득(3턴)(1회 피격 후 해제), 자신을 방어 상태로 전환 [CD: 3]`
                },
                [SkillType.ATTACK]: {
                    name: `뭘 봐!`,
                    description: `자신의 공격 데미지의 89%만큼 타깃에게 데미지, 자신이 받는 데미지 17% 감소(1턴)`
                },
                [SkillType.LEADER]: {
                    name: `크리스마스 계승자`,
                    description: `아군 전체의 최대 HP 20% 증가\n아군 전체에게 도발 면역 효과 부여\n아군 전체는 「팀에 최소 3명 이상의 탱커가 있을 시 『공격 데미지 140% 증가』발동」획득\n아군 전체는 「팀에 최소 3명 이상의 탱커가 있을 시 『가하는 데미지 100% 증가』발동」획득\n아군 전체는 「팀에 최소 3명 이상의 탱커가 있을 시 『《빠따는 훌륭한 대화 수단!》』발동」획득\n아군 전체는 「팀에 최소 3명 이상의 탱커가 있을 시 『《난 별 볼 일 없어》』발동」획득\n\n《빠따는 훌륭한 대화 수단!》\n피격 시 「타깃이 받는 발동형 스킬 데미지 20% 증가(최대 10중첩)」발동\n\n《난 별 볼 일 없어》\n궁극기 발동 시 「자신은 《그래도 넌 내가 이김!》획득」발동\n\n《그래도 넌 내가 이김!》\n피격 시 「자신의 공격 데미지의 250%만큼 타깃에게 반격(1회 발동 후 해제)」발동(3턴)`
                },
                [SkillType.PASSIVE_1]: {
                    name: `늑대가 뒤를 돌아본 것은!`,
                    description: `궁극기 CD 변동 효과 면역\n첫 번째 턴&3턴마다 「자신은 2중첩의 《싸움상등!》획득」발동\n피격 시 「자신은 1중첩의 《싸움상등!》획득」발동\n\n《싸움상등!》\n자신은 문자 효과 《싸움상등!》획득(최대 10중첩)\n자신의 공격 데미지 5% 증가(최대 10중첩)`
                },
                [SkillType.PASSIVE_2]: {
                    name: `보은 때문이 아닌!`,
                    description: `자신의 《싸움상등!》 중첩수≧3중첩일 시, 「가하는 데미지 5% 증가」발동\n자신의 《싸움상등!》 중첩수≧6중첩일 시, 「가하는 데미지 10% 증가」발동\n자신의 《싸움상등!》 중첩수≧9중첩일 시, 「가하는 데미지 15% 증가」발동`
                },
                [SkillType.PASSIVE_3]: {
                    name: `복수를 위해서다!`,
                    description: `자신의 《싸움상등!》 중첩수=10중첩일 시 「《요로시꾸!》」\n\n《요로시꾸!》\n행동 시 「자신은 《빠가야로!》획득」발동\n\n《빠가야로!》\n피격 시 「자신의 공격 데미지 100%만큼 타깃에게 반격(1회 피격 후 해제)」발동(1턴)`
                },
                [SkillType.GENERAL_1]: {
                    name: `데미지+`,
                    description: `자신의 가하는 데미지 7.5% 증가`
                },
                [SkillType.GENERAL_2]: {
                    name: `마비 면역`,
