...
export const SkillSet_10068: SkillSet[] =  [
    {
        version: 1,
        lastDate: "",
        remark: {
        ...
        skill: {
            [Locale.tc]: {
                [SkillType.SKILL_S]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力133/149/165/182/198%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加5/5/7.5/10/12.5%(最多3層)，CD: 3`
                },
                [SkillType.SKILL_1]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力133%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加5%(最多3層)，CD: 3`
                },
                [SkillType.SKILL_2]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力149%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加5%(最多3層)，CD: 3`
                },
                [SkillType.SKILL_3]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力165%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加7.5%(最多3層)，CD: 3`
                },
                [SkillType.SKILL_4]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力182%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加10%(最多3層)，CD: 3`
                },
                [SkillType.SKILL_5]: {
                    name: `上菜囉！這是會發光的昇龍餃子！`,
                    description: `以自身攻擊力198%對我方全體進行治療，使我方全體被治療時回復量增加45%(效果會在3回合內逐漸減少)，並使我方全體必殺傷害增加12.5%(最多3層)，CD: 3`
                },
                [SkillType.ATTACK]: {
                    name: `開飯囉~`,
                ...
                [SkillType.PASSIVE_1]: {
                    name: `上菜囉！這是海鮮蒸餃！`,
                    description: `每經過3回合，觸發「使我方全體被治療時回復量增加35%(3回合)」`
                },
                [SkillType.PASSIVE_2]: {
                    name: `上菜囉！這是奶油燉菜！`,
                    description: `每經過3回合，觸發「以自身最大HP10%對我方全體施放護盾(1回合)、攻擊力增加20%(1回合)」`
                },
                [SkillType.PASSIVE_3]: {
                    name: `上菜囉！這是頂級"凱薩"牛排！`,
            ...
            [Locale.sc]: {
                [SkillType.SKILL_S]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力133/149/165/182/198%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加5/5/7.5/10/12.5%(最多3层)，CD: 3`
                },
                [SkillType.SKILL_1]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力133%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加5%(最多3层)，CD: 3`
                },
                [SkillType.SKILL_2]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力149%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加5%(最多3层)，CD: 3`
                },
                [SkillType.SKILL_3]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力165%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加7.5%(最多3层)，CD: 3`
                },
                [SkillType.SKILL_4]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力182%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加10%(最多3层)，CD: 3`
                },
                [SkillType.SKILL_5]: {
                    name: `上菜罗！这是会发光的升龙饺子！`,
                    description: `以自身攻击力198%对我方全体进行治疗，使我方全体被治疗时回复量增加45%(效果会在3回合内逐渐减少)，并使我方全体必杀伤害增加12.5%(最多3层)，CD: 3`
                },
                [SkillType.ATTACK]: {
                    name: `开饭罗~`,
                ...
                [SkillType.LEADER]: {
                    name: `有种饿叫作我觉得你饿~`,
                    description: `使我方全体攻击力增加30%\n使我方全体最大HP增加30%\n使自身以外的所有队员获得《饥肠辘辘》\n使自身以外的所有队员获得《已经~吃不下了~》\n\n《饥肠辘辘》\n自身当前HP≤50%时，发动「被治疗时回复量增加100%」(50回合)\n\n《已经~吃不下了~》\n自身当前HP≥99%时，发动「攻击力增加40%」(50回合)`
                },
                [SkillType.PASSIVE_1]: {
                    name: `上菜罗！这是海鲜蒸饺！`,
                    description: `每经过3回合，触发「使我方全体被治疗时回复量增加35%(3回合)」`
                },
                [SkillType.PASSIVE_2]: {
                    name: `上菜罗！这是奶油炖菜！`,
                    description: `每经过3回合，触发「以自身最大HP10%对我方全体施放护盾(1回合)丶攻击力增加20%(1回合)」`
                },
                [SkillType.PASSIVE_3]: {
                    name: `上菜罗！这是顶级"凯萨"牛排！`,
            ...
            [Locale.jp]: {
                [SkillType.SKILL_S]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の133/149/165/182/198%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを5/5/7.5/10/12.5%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.SKILL_1]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の133%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを5%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.SKILL_2]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の149%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを5%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.SKILL_3]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の165%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを7.5%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.SKILL_4]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の182%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを10%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.SKILL_5]: {
                    name: `完成！光り輝く昇龍餃子だよ！`,
                    description: `自分の攻撃力の198%分味方全体に治療を行い、味方全体が治療を受けた時の回復HP量を45%増加させ(効果は3ターンかけて減少する)、味方全体の必殺技ダメージを12.5%増加させる(最高3スタック)[CD: 3]`
                },
                [SkillType.ATTACK]: {
                    name: `いっただきま~す`,
                ...
                [SkillType.LEADER]: {
                    name: `お腹すいてるでしょ~`,
                    description: `味方全体の攻撃力を30%増加させる\n味方全体の最大HPを30%増加させる\n自分以外の味方メンバー全員が《腹ぺこ》を得る\n自分以外の味方メンバー全員が《もう…食べられない…》を得る\n\n《腹ぺこ》\n自分の現在のHPが50%以下の時「治療を受けた時の回復量が100%増加する」を発動する(50ターン)\n\n《もう…食べられない…》\n自分の現在のHPが99%以上の時「攻撃力が40%増加する」を発動する(50ターン)`
                },
                [SkillType.PASSIVE_1]: {
                    name: `料理完成！海鮮餃子だよ！`,
                    description: `3ターン毎に「味方が治療を受けるとき、回復HP量が35%増加する(3ターン)」を誘発する`
                },
                [SkillType.PASSIVE_2]: {
                    name: `料理完成！野菜シチューだよ！`,
                    description: `3ターン毎に「自分の最大HPの10%分味方全体に盾を張り(1ターン)、攻撃力を20%増加させる(1ターン)」を誘発する`
                },
                [SkillType.PASSIVE_3]: {
                    name: `料理完成！シーザーステーキだよ!`,
                    description: `3ターン毎に「味方全体の必殺技ダメージを30%増加させ(1ターン)、攻撃力を自分の攻撃力の20%分増加させる(1ターン)」を誘発する`
                },
                [SkillType.GENERAL_1]: {
                    name: `ダメージ減少+`,
